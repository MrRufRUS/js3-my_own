...
let correspond = {
  "Название": "languageName",
  "Год выпуска": ["yearFrom", "yearTo"],
  "Тип языка": "typeOfLanguage",
  "Рейтинг": ["ratingFrom", "ratingTo"],
  "Октябрь 2023": ["october2023From", "october2023To"],
  "Октябрь 2022": ["october2022From", "october2022To"]
 }
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  setSortSelects(languages[0], document.getElementById('sort'));
});
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  firstSelect.addEventListener('change', () => {
    ...
    changeNextSelect('fieldsThird', secondSelect, 'fieldsThird'); 
...
document.addEventListener('DOMContentLoaded', () => {
  let thirdSelect = document.getElementById('fieldThird');
  thirdSelect.addEventListener('change', () => {
    
    changeNextSelect('fieldsThird', thirdSelect, 'fieldsThird'); 
  })
});
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  searchButton.addEventListener('click', function() {
    ...
    filterTable(languages, 'list', form);
  });
});
